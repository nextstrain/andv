...
rule run_nextclade:
    ...
    input:
        sequences="results/all/sequences.fasta",
        segment_reference = "../phylogenetic/defaults/{DATASET_NAME}/reference.fasta",
    output:
    ...
    shell:
        ...
        nextclade3 run \
            --input-reference {input.segment_reference:q} \
            -j {threads:q} \
